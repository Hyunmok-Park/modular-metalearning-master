...
def main():
  ...
  parser.add_argument('--mini_batch_size', dest='mini_batch_size', type=int,
                      default=10, help='Number of minibatch')
  parser.add_argument('--auto_temp', dest='auto_temp',
          action='store_true',
          help='anytime temperature schedule based on current train loss')

  parser.add_argument('--num_train', dest='num_train', type=int,
                      default=10, help='num_train')
  parser.add_argument('--num_val', dest='num_val', type=int,
                      default=10, help='num_val')
  parser.add_argument('--num_test', dest='num_test', type=int,
                      default=10, help='num_test')
